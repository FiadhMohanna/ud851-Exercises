...
public class NotificationUtils {
    ...
    //      TODO (7) Set the action of the intent to designate you want to dismiss the notification
        intent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATIONS);
    ...
    //      TODO (9) Create an Action for the user to ignore the notification (and dismiss it)
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,"Ignore", pendingIntent);
    //      TODO (10) Return the action
        return action;
    }

    //  TODO (11) Add a static method called drinkWaterAction
    public static NotificationCompat.Action dringWaterAction(Context context){
    ...
    //      TODO (14) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent pendingIntent = PendingIntent.getService(context,20,intent,PendingIntent.FLAG_CANCEL_CURRENT);
    //      TODO (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_local_drink_black_24px,"Drink", pendingIntent);
